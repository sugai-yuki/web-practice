  ...
  actions: {
    async login({ commit }, { email, password }) {
      let responseLogin = await axios.post(
        "https://cryptic-hollows-00296.herokuapp.com/api/login",
        {
          email: email,
          password: password,
        }
      ...
      let responseUser = await axios.get(
        "https://cryptic-hollows-00296.herokuapp.com/api/user",
        {
          params: {
            email: email,
          }
    ...
    logout({ commit }) {
      axios
        .post("https://cryptic-hollows-00296.herokuapp.com/api/logout", {
